...
describe('Singly linked list', () => {
  ...
  describe('Push & Pop items', () => {
    ...
    it('should have same value', () => {
      ...
      expect(list.head.previous).toBeFalsy();
      expect(list.head.next.value).toBe('testing');
      expect(list.tail.previous.value).toBe('structure');
    ...
    it('should pop an item from list', () => {
      ...
      expect(removedNode.previous).toBeFalsy();
    ...
    it('should have one item/head only', () => {
      ...
      expect(removedTailNode.previous).toBeFalsy();
  ...
  describe('Shift and Unshift items', () => {
    ...
    it('should insert at the beginning', () => {
      ...
      expect(list.head.next.value).toBe('fourth');
      expect(list.head.previous).toBeFalsy();
      expect(list.tail.value).toBe('first');
      expect(list.tail.previous.value).toBe('second');
      expect(list.tail.next).toBeFalsy();
    });
  ...
  describe('Insert and Remove', () => {
    ...
    it('should can insert an item into a spesific index', () => {
      ...
      // 10 44 34 68 27 9 13 24 51 86 99

      const first = list.get(0);
      const fifth = list.get(5);

      expect(first.value).toBe(10);
      expect(first.previous).toBeFalsy();
      expect(first.next.value).toBe(44);
      expect(list.get(1).value).toBe(44);
      expect(list.get(3).value).toBe(68);
      expect(fifth.value).toBe(9);
      expect(fifth.next.value).toBe(13);
      expect(fifth.previous.value).toBe(27);
